...
//Befor runing the code make sure to instal: cURL library: This is needed for making HTTP requests to the weather API.
//                                          GCC/G++: The GNU Compiler Collection to compile the C++ code.
#include <iostream>
#include <string>
#include <vector>
#include <sstream>
...
int main() {
    ...
    vector<Info> activities = {
        ...
        {"Night_partying", "Mykonos", {1, 2}, {8, 9}},
